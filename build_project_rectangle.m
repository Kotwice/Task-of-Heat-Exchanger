...
function model = build_component_rough (model, parameters)
    ...
    model.component('rough').selection.create('selection_in_st_r', 'Box');
        ...
        model.component('rough').selection('selection_in_st_r').set('ymin', '0.01 * l_st_in');
        model.component('rough').selection('selection_in_st_r').set('ymax', '0.99 * l_st_in');
    ...
    model.component('rough').selection.create('selection_ht_r', 'Box');
        ...
        model.component('rough').selection('selection_ht_r').set('ymin', 'l_st_in + 0.01 * n * (s_r + w_r)');
        model.component('rough').selection('selection_ht_r').set('ymax', 'l_st_in + 0.99 * n * (s_r + w_r)');
    ...
    model.component('rough').selection.create('selection_out_st_r', 'Box');
        ...
        model.component('rough').selection('selection_out_st_r').set('ymin', 'l_st_in + n * (s_r + w_r) + 0.01 * l_st_out');
        model.component('rough').selection('selection_out_st_r').set('ymax', 'l_st_in + n * (s_r + w_r) + 0.99 * l_st_out');
    ...
    model.component('rough').selection.create('selection_inter_task_1', 'Box');
        ...
        model.component('rough').selection('selection_inter_task_1').set('ymin', '0.01 * l_st_in');
        model.component('rough').selection('selection_inter_task_1').set('ymax', '0.99 * (l_st_in + n * (s_r + w_r) + l_st_out)');
    ...
    model.component('rough').selection.create('selection_inter_task_2', 'Box');
        ...
        model.component('rough').selection('selection_inter_task_2').set('ymin', '0.01 * l_st_in');
        model.component('rough').selection('selection_inter_task_2').set('ymax', '0.99 * (l_st_in + n * (s_r + w_r) + l_st_out)');
    ...
    model.component('rough').selection.create('selection_wall_ht_1', 'Box');
        ...
        model.component('rough').selection('selection_wall_ht_1').set('ymin', 'l_st_in + 0.01 * n * (s_r + w_r)');
        model.component('rough').selection('selection_wall_ht_1').set('ymax', '0.99 * (l_st_in + n * (s_r + w_r))');
    ...
    model.component('rough').selection.create('selection_wall_st_in_r', 'Box');
        ...
        model.component('rough').selection('selection_wall_st_in_r').set('ymin', '0.01 * l_st_in');
        model.component('rough').selection('selection_wall_st_in_r').set('ymax', '0.99 * l_st_in');
    ...
    model.component('rough').selection.create('selection_wall_st_out_r', 'Box');
        ...
        model.component('rough').selection('selection_wall_st_out_r').set('ymin', 'l_st_in + n * (s_r + w_r) + 0.01 * l_st_out');
        model.component('rough').selection('selection_wall_st_out_r').set('ymax', 'l_st_in + n * (s_r + w_r) + 0.99 * l_st_out');
...
function model = set_studies (model)
    ...
    model.study.create('std_sweep_opt_normal');
        ...
        model.study('std_sweep_opt_normal').create('stat', 'Stationary');
            ...
            model.study('std_sweep_opt_normal').feature('stat').setIndex('mesh', 'mesh_smooth_normal', 1);
